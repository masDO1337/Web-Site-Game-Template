...
export class Running extends State {
    ...
    handleInput(input){
        ...
        if (input.includes('s')) this.game.player.setState(states.SITTING, 0);
...
export class Jumping extends State {
    ...
    handleInput(input){
        ...
        else if (input.includes('s')) this.game.player.setState(states.DIVING, 0);
    }
}
...
export class Rolling extends State {
    ...
    handleInput(input){
        ...
        else if (input.includes(' ') && input.includes('w') && this.game.player.onGround()) this.game.player.vy -= 27;
        else if (input.includes('s') && !this.game.player.onGround()) this.game.player.setState(states.DIVING, 0);
    }
}
...
export class Diving extends State {
    ...
    handleInput(input){
        ...
        else if (input.includes(' ') && this.game.player.onGround()) this.game.player.setState(states.ROLLING, 1);
    }
}
